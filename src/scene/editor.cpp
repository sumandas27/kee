...
compose_tab_key::compose_tab_key(const kee::ui::required& reqs, kee::scene::compose_tab& compose_tab_scene, int key_id) :
    kee::ui::button(reqs,
        pos(pos::type::rel, 0.5f),
        pos(pos::type::rel, 0.5f),
...
compose_tab::compose_tab(const kee::ui::required& reqs) :
    kee::ui::base(reqs,
        pos(pos::type::rel, 0),
